...
public class UserData : ScriptableObject
{
    ...
    public void SaveAllData()
    {
        ...
        PlayerPrefs.SetInt(Key_Coin, coin);
        PlayerPrefs.SetInt(Key_RemoveAds, removeAds ? 1 : 0);
        PlayerPrefs.SetInt(Key_Tutorial, tutorialed ? 1 : 0);
        PlayerPrefs.SetInt(Key_SoundIsOn, soundIsOn ? 1 : 0);
        PlayerPrefs.SetInt(Key_Vibrate, vibrate ? 1 : 0);

        SetEnumData(Key_Player_Weapon, playerWeapon);
        SetEnumData(Key_Player_Hat, playerHat);
        SetEnumData(Key_Player_Pant, playerPant);
        SetEnumData(Key_Player_Accessory, playerAccessory);
        SetEnumData(Key_Player_Skin, playerSkin);
    ...
    public void OnInitData()
    {
        ...
        playerWeapon = GetEnumData(Key_Player_Weapon, WeaponType.W_Hammer);
