...
public class UIShop : UICanvas
{
    ...
    public override void CloseDirectly()
    {
        ...
        LevelManager.Ins.player.TakeOffSkin();
        LevelManager.Ins.player.OnTakeSkinData();
        LevelManager.Ins.player.WearSkin();
    }
