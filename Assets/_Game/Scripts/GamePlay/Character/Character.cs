...
public class Character : GameUnit, IHit
{
    ...
    public const float ATT_RANGE = 4f;
    ...
    public Character GetTargetInRange()
    {
        ...
        float distance = float.PositiveInfinity; // khoảng cách lớn nhất ban đầu
