...
{
    [SerializeField] RectTransform rect;        //biểu tượng chỉ thị
    [SerializeField] Image iconImg;             //hình ảnh biểu tượng
    [SerializeField] Image directImg;           //hình ảnh mũi tên chỉ hướng
    [SerializeField] RectTransform direct;      //mũi tên chỉ hướng
    [SerializeField] TextMeshProUGUI nameTxt;   //tên mục tiêu
    [SerializeField] TextMeshProUGUI scoreTxt;  //điểm mục tiêu

    [SerializeField] CanvasGroup canvasGroup;   //nhóm canvas để điều chỉnh alpha
